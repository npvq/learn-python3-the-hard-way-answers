...
your ship and destroyed your entire crew. You are the last surviving member \
and your last mission is to get the neutron destruct  bomb from the Weapons \
Armory, put it in the bridge, and blow the ship up after getting into an escape \
pod. \n\n\
...
insults in the academy. You tell the one Gothon joke you know:  Lbhe zbgure vf \
fb sng, jura fur fvgf nebhaq gur ubhfr,  fur fvgf nebhaq gur ubhfr. The Gothon \
stops, tries  not to laugh, then busts out laughing and can't move.  While he's \
laughing you run up and shoot him square in  the head putting him down, then \
jump through the  Weapon Armory door.\n\n\
You do a dive roll into the ship's Weapon Armory, crouch and scan  the room \
for more Gothons that might be hiding. It's dead  quiet, too quiet. You stand \
...
gas out. You grab the neutron bomb and run as fast as  you can to the bridge \
...
Gothons put their hands up and start to sweat.  You inch backward to the door, \
open it, and then  carefully place the bomb on the floor, pointing your  blaster \
at it. You then jump back through the door,  punch the close button and blast \
the lock so the  Gothons can't get out. Now that the bomb is placed  you run to \
