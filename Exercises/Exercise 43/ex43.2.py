...
# naturally thinking in code about problems.
"""
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        print(dedent("""
            You do a dive roll into the ship's {} Weapon Armory, crouch and
            scan  the room for more Gothons that might be hiding. It's dead 
        ...
        guess = ""  # <–– this line gives the player an extra guess, therefore
        # making the total number of guesses 11 and not 10. removed line.
        guesses = 0

        while guess != code and guesses < 10:
            print("BZZZZEDDDD!")
            guesses += 1
            guess = input("[keypad]" + prompt)
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        print(dedent("""
            ...
            like hardly {} Gothons are on the ship, so your run is 
...
# An FSM (Finite State Machine) is one that is always in one of a finite number
# of states. It can transition to other states when there are specific inputs.
# The behavior of an FSM is common in modern society, on machines that deal
# with a predetermined sequence of actions based on a sequence of events
# presented. Examples are: Vending machines, traffic lights, elevators.
